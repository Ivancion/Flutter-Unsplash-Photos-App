...
class UserLikedPhotosCubit extends Cubit<UserLikedPhotosCubitState> {
  int totalLikes;
    ...
    switch (blocState.status) {
      ...
      case DataStatus.success:
        ...
        final newState = state.copyWith(
          photos: photos,
          status: UserLikedPhotosCubitStateStatus.success,
        );
        emit(newState);
        break;
      case DataStatus.failure:
        emit(state.copyWith(status: UserLikedPhotosCubitStateStatus.error));
        break;
  ...
  Future<void> _loadMore() async {
    if (state.status == UserLikedPhotosCubitStateStatus.error) return;
